...
namespace Kitias.Providers.Interfaces
{
	...
	public interface IAttendanceProvider
	{
		...
		Task<Result<ShedulerStudentsGroup>> TakeShedulerStudentsGroupAsync(Guid id);
		/// <summary>
		...
		Task<Result<IEnumerable<SubjectDto>>> TakeTeacherShedulerSubjectsAsync(Guid id, string email);
		/// <summary>
		...
		Task<Result<IEnumerable<AttendanceDto>>> UpdateAttendancesAsync(Guid id, IEnumerable<AttendanceRequestModel> models);
		/// <summary>
		/// Update attendance
		/// </summary>
